...
/***/ function(module, exports, __webpack_require__) {
	...
	var comments = __webpack_require__(8);

	__webpack_require__(31)($);

	var displayRatings = function displayRatings(ratings, flagID) {
	  ...
	  var avgRating = flagRatings.reduce(function (a, b) {
	    return a + b;
	  }, 0) / flagRatings.length;
	  if (!avgRating) {
	    avgRating = '(none yet)';
	  }
	...
	var getRatings = function getRatings(flagID) {
	  $.ajax({
	    url: app.api + "/ratings/"
	  }). // method: 'GET',
	  // dataType: 'json'
	...
	var displayFlag = function displayFlag(flag) {
	  var display = __webpack_require__(32);
	  $('.flagDisplay, .flag-comments').empty();
	  $('.flagName').text(function () {
	    return flag.name;
	  });
	  $('.flagDisplay').append(display({ flag: flag }));
	  getRatings(flag.id);
	  comments.getComments(flag.id);
	};

	var getFlag = function getFlag(id) {
	  $.ajax({
	...
	var displayFlags = function displayFlags(flags) {
	  var flagsTemplate = __webpack_require__(33);
	  $('.content').append(flagsTemplate({ flags: flags }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var submitComment = function submitComment(success, failure, content, flag_id) {
	  $.ajax({
	    method: 'POST',
	...
	var editComment = function editComment(success, failure, content, id) {
	  $.ajax({
	    method: 'PATCH',
	...
	var deleteComment = function deleteComment(success, failure, id) {
	  $.ajax({
	    method: 'DELETE',
	    url: app.api + '/comments/' + id,
	    headers: {
	...
	var submitRating = function submitRating(success, failure, score, flag_id) {
	  $.ajax({
	    method: 'POST',
	    url: app.api + '/ratings/',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayComments = function displayComments(comments, flagID) {
	  $('.flag-comments').empty();
	  var display = __webpack_require__(10);
	  var displaySelf = __webpack_require__(30);
	  // let commentIDs = [];
	  ...
	  for (var i = 0; i < comments.length; i++) {
	    if (!!app.user && comments[i].flag.id === flagID && comments[i].user.email === app.user.email) {
	      ...
	      $('.flag-comments').append(displaySelf({ comment: comment }));
	    } else if (comments[i].flag.id === flagID) {
	      var _comment = comments[i];
	      $('.flag-comments').append(display({ comment: _comment }));
	    }
	  }
	  handlers.clickHandlers();
	};

	var getComments = function getComments(flagID) {
	  $.ajax({
	    url: app.api + "/comments/"
	  }). // method: 'GET',
	  // dataType: 'json'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clickHandlers = function clickHandlers() {
	  ...
	  $('.edit-comment').on('click', function () {
	    ...
	    var content = $(this).parent().parent().find('.comment-content').text();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"well comment\">\n    <header>Posted by: "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.user : stack1)) != null ? stack1.email : stack1), depth0))
	    + " at "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.created_at : stack1), depth0))
	    + "</header>\n    <main>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.content : stack1), depth0))
	    + "</main>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"well comment\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.id : stack1), depth0))
	    + ">\n    <header class=\"comment-data\">Posted by: you at "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.created_at : stack1), depth0))
	    + " - <a class=\"edit-comment\">Edit</a> - <a class=\"delete-comment\">Delete</a>\n      <span class=\"delete-confirm hidden\">Are you sure you want to delete this comment? <a class=\"delete-comment-yes\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.id : stack1), depth0))
	    + ">Yes</a> | <a class=\"delete-comment-no\">No</a></span>\n    </header>\n    <main class=\"comment-content\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.content : stack1), depth0))
	    + "</main>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<img src="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.flag : depth0)) != null ? stack1.imgurl : stack1), depth0))
	    + " class=\"img-responsive flag\" data-id="
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.flag : depth0)) != null ? stack1.id : stack1), depth0))
	    + " />\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <li class=\"flag-tile\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">\n      <img class=\"img-responsive gallery-flag\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " data-original="
	  ...
	  return "<ul class=\"grid\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.flags : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</ul>\n";
	},"useData":true});
